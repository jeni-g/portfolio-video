      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            A collection of projects showcasing my skills in web development, mobile applications, AI integration, and problem-solving.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard
            number="01"
            title="WOMEN SAFETY CHATBOT APP"
            text="Flutter-based safety application featuring SOS alerts, GPS tracking, chatbot support, and offline SQLite database integration."
          ...
          <TagCard
            number="02"
            title="CAMPUS PORTAL"
            text="Developed a student management portal using Django,Bootstrap, SQLite, authentication modules, and REST APIs for efficient academic data handling."
          ...
          <TagCard
            ...
            text="AI-powered web application that summarizes lengthy documents using the Gemini API, improving content accessibility and productivity." 
          ...
          <TagCard
            ...
            text="Built a responsive personal portfolio using React, Tailwind CSS, Framer Motion, and modern UI/UX design principles."
