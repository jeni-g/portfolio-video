  ...
  const skillsData = [
    {
      ...
      skills: ['Python', 'Dart', 'JavaScript', 'SQL'],
    },
    {
    ...
    },
    {
      ...
      skills: ['Django', 'REST APIs', 'API Integration', 'Authentication'],
    },
    {
    ...
    },
    {
      ...
      skills: ['Git', 'GitHub', 'VS Code', 'Postman', 'Jira', 'XAMPP', 'Canva', 'Functional Testing', 'Regression Testing'],
    },
  ];
  ...
  return (
    <section id="skills" className="relative w-full bg-white py-16 md:py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-8">
        ...
        >
          <div className="mb-3">
            <span className="inline-block px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-gray-600 bg-white border border-gray-200 rounded-full shadow-sm">
              Skills & Technologies
            </span>
          </div>
          ...
          <p className="text-sm text-black/60 font-normal">
            A collection of technologies, frameworks, and tools I use for web and mobile application development.
          </p>
        </motion.div>
