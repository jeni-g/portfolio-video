...
const Navbar = () => {
  ...
  const navLinks = [ 'About', 'Projects', 'Skills', 'internship', 'Certifications', 'Contact'];
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-10 flex justify-between items-center">
        
        {/* Left Side: Dynamic Logo font node configurations */}
        <div className="flex items-center">
          <a 
            href="#" 
            className={`text-xl lg:text-2xl font-black tracking-tight transition-colors duration-500 ${
              isOpen || !isScrolled ? 'text-white' : 'text-gray-900'
            }`}
          >
            Jeni G Hannah <span className="text-[#ff2a2a]">.</span>
          </a>
        </div>
      ...
      <div 
        className={`xl:hidden absolute top-full left-0 w-full transition-all duration-500 ease-in-out ${
